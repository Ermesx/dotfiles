...
if ($paths -notcontains "$gitInstallDir\bin") { $env:Path += ";$gitInstallDir\bin" }
if ($paths -notcontains "$gitInstallDir\cmd") { $env:Path += ";$gitInstallDir\cmd" }
if ($paths -notcontains "$gitInstallDir\mingw\bin") { $env:Path += ";$gitInstallDir\mingw\bin" }
